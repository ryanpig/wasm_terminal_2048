...
export class GameController {
    ...
    */
    static new() {
        var ret = wasm.gamecontroller_new();
    ...
    */
    run() {
        try {
            ...
            wasm.gamecontroller_run(retptr, this.ptr);
    ...
    */
    get_steps() {
        var ret = wasm.gamecontroller_get_steps(this.ptr);
        return ret >>> 0;
    }
    /**
    */
    start_new_game() {
        wasm.gamecontroller_start_new_game(this.ptr);
    }
    /**
    * @returns {boolean}
    */
    next() {
        var ret = wasm.gamecontroller_next(this.ptr);
        return ret !== 0;
    }
    /**
    ...
    */
    action(direction) {
        wasm.gamecontroller_action(this.ptr, direction);
    }
    /**
    * @returns {string}
    */
    render() {
        try {
            const retptr = wasm.__wbindgen_export_0.value - 16;
            wasm.__wbindgen_export_0.value = retptr;
            wasm.gamecontroller_render(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
